...
Tek bir altın referans hesaplayıcıdan (VKİ) başlayarak beş kategorinin tamamında 100+ hesaplayıcıya ulaşacağız. Sağlık ve finans öncelikli, çünkü en çok aranan kategoriler.`,
  ...
  de: {
    title: "Über uns",
    body: `Karaman Calculators ist eine kostenlose, mehrsprachige Sammlung von Online-Rechnern für den Alltag — Finanzen, Gesundheit, Technik, Mathematik und Einheitenumrechnung.
...
Wir wachsen von einem einzigen Goldstandard-Rechner (BMI) auf 100+ Rechner in allen fünf Kategorien. Gesundheit und Finanzen haben Priorität, da sie am häufigsten gesucht werden.`,
  ...
  fr: {
    title: "À propos",
    body: `Karaman Calculators est une collection gratuite et multilingue de calculateurs en ligne pour la vie quotidienne — finances, santé, ingénierie, mathématiques et conversion d'unités.
...
Nous passons d'un seul calculateur de référence (IMC) à 100+ calculateurs dans les cinq catégories. La santé et les finances sont prioritaires, car ce sont les plus recherchées.`,
  ...
  es: {
    title: "Acerca de",
    body: `Karaman Calculators es una colección gratuita y multilingüe de calculadoras en línea para la vida cotidiana — finanzas, salud, ingeniería, matemáticas y conversión de unidades.
...
Estamos creciendo desde una única calculadora de referencia dorada (IMC) hasta 100+ calculadoras en las cinco categorías. La salud y las finanzas tienen prioridad, ya que son las más buscadas.`,
  ...
  it: {
    title: "Chi siamo",
    body: `Karaman Calculators è una raccolta gratuita e multilingue di calcolatori online per la vita quotidiana — finanza, salute, ingegneria, matematica e conversione di unità.
...
Stiamo crescendo da un unico calcolatore di riferimento (IMC) a 100+ calcolatori in tutte e cinque le categorie. Salute e finanza hanno la priorità, essendo le più ricercate.`,
  ...
  ar: {
    title: "حول",
    body: `Karaman Calculators هو مجموعة مجانية متعددة اللغات من الآلات الحاسبة عبر الإنترنت للحياة اليومية — المالية والصحة والهندسة والرياضيات وتحويل الوحدات.
...
ننمو من حاسبة مرجعية واحدة (مؤشر كتلة الجسم) إلى أكثر من 100 حاسبة في جميع الفئات الخمس. الصحة والمالية لها الأولوية، لأنها الأكثر بحثاً.`,
  ...
  ru: {
    title: "О нас",
    body: `Karaman Calculators — это бесплатная многоязычная коллекция онлайн-калькуляторов для повседневной жизни — финансы, здоровье, инженерия, математика и конвертация единиц.
...
Мы растём от одного эталонного калькулятора (ИМТ) до 100+ калькуляторов во всех пяти категориях. Здоровье и финансы в приоритете, так как они наиболее часто ищут.`,
  ...
  zh: {
    title: "关于",
    body: `Karaman Calculators 是一个免费的多语言在线计算器集合，服务于日常生活 — 金融、健康、工程、数学和单位换算。
...
我们正在从单一的黄金参考计算器（BMI）扩展到五个类别中的 100 多个计算器。健康和金融优先，因为它们是搜索最频繁的类别。`,
  ...
  ja: {
    title: "概要",
    body: `Karaman Calculators は、日常生活のための無料の多言語オンライン計算ツールのコレクションです — 金融、健康、工学、数学、単位換算。
...
単一のゴールデンリファレンス計算ツール（BMI）から、5つすべてのカテゴリにわたる100以上の計算ツールへと成長しています。健康と金融が最も検索されるため優先されます。`,
  ...
  ko: {
    title: "소개",
    body: `Karaman Calculators는 일상생활을 위한 무료 다국어 온라인 계산기 모음입니다 — 금융, 건강, 공학, 수학, 단위 변환.
...
단일 황금 참조 계산기(BMI)에서 5개 카테고리 전반에 걸쳐 100개 이상의 계산기로 성장하고 있습니다. 건강과 금융이 가장 많이 검색되기 때문에 우선순위가 높습니다.`,
  ...
  hi: {
    ...
    body: `Karaman Calculators रोज़मर्रा की ज़िंदगी के लिए मुफ़्त, बहुभाषी ऑनलाइन कैलकुलेटर का एक संग्रह है — वित्त, स्वास्थ्य, इंजीनियरिंग, गणित और इकाई रूपांतरण।
