...
const data = {
  ...
  pt: { title: "CSS Formatter", short: "Beautify and indent CSS with one click.", description: "Free CSS beautifier. Paste minified or messy CSS to get a clean, indented version with one rule per line — runs entirely in your browser.", keywords: ["css formatter", "css beautifier", "format css", "pretty print css", "css indent"], input: "CSS", output: "Formatted CSS" },
  id: { title: "CSS Formatter", short: "Beautify and indent CSS with one click.", description: "Free CSS beautifier. Paste minified or messy CSS to get a clean, indented version with one rule per line — runs entirely in your browser.", keywords: ["css formatter", "css beautifier", "format css", "pretty print css", "css indent"], input: "CSS", output: "Formatted CSS" },
