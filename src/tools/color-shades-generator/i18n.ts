...
const data = {
  ...
  pt: { title: "Color Shades Generator", short: "Generate tints and shades of any color.", description: "Free color shades generator. Pick a color and the number of steps to get a row of tints and shades from light to dark, each with its hex code.", keywords: ["color shades generator", "tints and shades", "color tints generator", "shade generator", "color variations"], baseColor: "Base color", steps: "Steps" },
  id: { title: "Color Shades Generator", short: "Generate tints and shades of any color.", description: "Free color shades generator. Pick a color and the number of steps to get a row of tints and shades from light to dark, each with its hex code.", keywords: ["color shades generator", "tints and shades", "color tints generator", "shade generator", "color variations"], baseColor: "Base color", steps: "Steps" },
