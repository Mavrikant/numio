...
export default function HtmlToMarkdownTool({ locale }: { readonly locale: Locale }) {
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        <div className="flex items-center justify-between">
          ...
          <CopyButton text={md} label={ui.copy} copiedLabel={ui.copied} />
        </div>
        <TextArea value={md} rows={10} readOnly />
      </div>
    </div>
  );
}
