...
const data = {
  ...
  pt: { title: "Formatador de XML", short: "Formatar e indent XML com a clean structure.", description: "Gratuito - XML formatter e beautifier. Paste messy ou minified XML para get clean, indented output you can read e copy â all no seu navegador.", keywords: ["xml formatter", "xml beautifier", "format xml", "pretty print xml", "xml indent online"], input: "XML", output: "Formatted XML" },
  id: { title: "Formatter XML", short: "Format dan indent XML with a clean structure.", description: "Gratis - XML formatter dan beautifier. Paste messy atau minified XML to get clean, indented output you can read dan copy â all di browser Anda.", keywords: ["xml formatter", "xml beautifier", "format xml", "pretty print xml", "xml indent online"], input: "XML", output: "Formatted XML" },
