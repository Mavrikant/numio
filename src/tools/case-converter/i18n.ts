...
const meta = {
  ...
  nl: { title: "Hoofdletter Converteerer", short: "Converteer tekst to UPPERCASE, lowercase, Title Hoofdletter, camelHoofdletter, snake_case and more.", description: "Gratis online case converteerer. Paste tekst and switch direct between UPPERCASE, lowercase, Title Hoofdletter, Sentence case, camelHoofdletter, PascalHoofdletter, snake_case and kebab-case. Runs entirely in uw browser.", keywords: ["case converteerer", "uppercase", "lowercase", "title case", "camelcase", "snake case", "kebab case"] },

  pl: { title: "Wielkość liter Konwerter", short: "Konwertuj tekst to UPPERCASE, lowercase, Title Wielkość liter, camelWielkość liter, snake_case and more.", description: "Darmowy online case konwerter. Paste tekst and switch natychmiast between UPPERCASE, lowercase, Title Wielkość liter, Sentence case, camelWielkość liter, PascalWielkość liter, snake_case and kebab-case. Runs entirely w Twojej przeglądarce.", keywords: ["case konwerter", "uppercase", "lowercase", "title case", "camelcase", "snake case", "kebab case"] },
  pt: { title: "Conversor de Case", short: "Converter text para UPPERCASE, lowercase, Title Case, camelCase, snake_case e more.", description: "Gratuito - online case converter. Paste text e switch instantaneamente entre UPPERCASE, lowercase, Title Case, Sentence case, camelCase, PascalCase, snake_case e kebab-case. Runs entirely no seu navegador.", keywords: ["case converter", "uppercase", "lowercase", "title case", "camelcase", "snake case", "kebab case"] },
  id: { title: "Konverter Case", short: "Konversi text to UPPERCASE, lowercase, Title Case, camelCase, snake_case dan more.", description: "Gratis - online case converter. Paste text dan switch secara instan antara UPPERCASE, lowercase, Title Case, Sentence case, camelCase, PascalCase, snake_case dan kebab-case. Runs entirely di browser Anda.", keywords: ["case converter", "uppercase", "lowercase", "title case", "camelcase", "snake case", "kebab case"] },
