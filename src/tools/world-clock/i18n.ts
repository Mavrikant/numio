...
const data = {
  ...
  pt: { title: "World Clock", short: "See the current time in major cities at a glance.", description: "Free world clock. Watch the live local time in San Francisco, New York, London, Istanbul, Tokyo and more — useful for distributed teams. Runs in your browser.", keywords: ["world clock", "city clocks", "global time", "current time worldwide", "time zone dashboard"] },
  id: { title: "World Clock", short: "See the current time in major cities at a glance.", description: "Free world clock. Watch the live local time in San Francisco, New York, London, Istanbul, Tokyo and more — useful for distributed teams. Runs in your browser.", keywords: ["world clock", "city clocks", "global time", "current time worldwide", "time zone dashboard"] },
