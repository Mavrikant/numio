...
const i18n: CalculatorI18n = {
  ...
  nl: {
    title: "Condensator Calculator",
    short: "Bereken capacitor charge, energy, reactance, and RC time constant.",
    description: "Gratis capacitor calculator. Enter capacitance, voltage, and frequency to bereken charge (Coulombs), energy (Joules), reactance (Ohms), and RC time constant.",
    keywords: ["capacitor", "capacitance", "charge", "energy", "reactance", "RC time constant", "electronics"],
    inputs: {
      capacitance: { label: "Capacitance", help: "Waarde in Farads (F). Use prefixes: μ=1e-6, n=1e-9, p=1e-12" },
      voltage: { label: "Voltage", help: "Voltage across capacitor in Volts" },
      frequency: { label: "Frequency", help: "AC frequency in Hz. Leave 0 for DC." },
    },
    outputs: {
  ...
  pl: {
    title: "Kondensator Kalkulator",
    short: "Oblicz capacitor charge, energy, reactance, and RC time constant.",
    description: "Darmowy capacitor kalkulator. Enter capacitance, voltage, and frequency to oblicz charge (Coulombs), energy (Joules), reactance (Ohms), and RC time constant.",
    keywords: ["capacitor", "capacitance", "charge", "energy", "reactance", "RC time constant", "electronics"],
    inputs: {
      capacitance: { label: "Capacitance", help: "Wartość in Farads (F). Use prefixes: μ=1e-6, n=1e-9, p=1e-12" },
      voltage: { label: "Voltage", help: "Voltage across capacitor in Volts" },
      frequency: { label: "Frequency", help: "AC frequency in Hz. Leave 0 for DC." },
    },
    outputs: {
