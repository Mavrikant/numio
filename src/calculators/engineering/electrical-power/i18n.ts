...
const i18n: CalculatorI18n = {
  ...
  nl: {
    title: "Elektrisch Vermogen Calculator",
    short: "Bereken voltage, current, resistance, and power consumption with energy cost estimation.",
    description:
      "Electrical power calculator for P=VI calculations. Find V, I, R, P from any two inputs. Estimate energy consumption and monthly costs.",
    keywords: [
      "power calculator",
    ...
    outputs: {
      ...
      energy24h: {
        label: "Daily Energy",
        help: "Energy consumed in 24 uren (kWh).",
      },
      energy30d: {
        label: "Monthly Energy",
        help: "Energy consumed in 30 dagen (kWh).",
      },
      costPerMonth: {
        label: "Monthly Cost",
        help: "Estimated cost based on average US rate ($0.15/kWh).",
    ...
    faq: [
      ...
      {
        q: "How is monthly electricity cost berekend?",
        a: "Cost = Power (kW) × Time (uren) × Rate ($/kWh). This calculator uses the US average rate of $0.15/kWh. Your actual rate may vary by location and utility company.",
      },
      {
        q: "What's the difference between watts and watt-uren?",
        a: "Watts measure instantaneous power (rate of energy use). Watt-uren (Wh) measure total energy consumed over time. 1 kilowatt-hour (kWh) = 1000 W × 1 hour.",
      },
      {
        q: "Can I bereken power from resistance and voltage?",
        a: "Yes. P = V² / R (voltage squared divided by resistance) gives power when you know voltage and resistance.",
      },
      {
        q: "How do I reduce my electricity bill?",
  ...
  pl: {
    title: "Moc Elektryczna Kalkulator",
    short: "Oblicz voltage, current, resistance, and power consumption with energy cost estimation.",
    description:
      "Electrical power kalkulator for P=VI calculations. Find V, I, R, P from any two inputs. Estimate energy consumption and monthly costs.",
    keywords: [
      "power kalkulator",
      "voltage current",
    ...
    outputs: {
      ...
      energy24h: {
        label: "Daily Energy",
        help: "Energy consumed in 24 godzin (kWh).",
      },
      energy30d: {
        label: "Monthly Energy",
        help: "Energy consumed in 30 dni (kWh).",
      },
      costPerMonth: {
        label: "Monthly Cost",
        help: "Estimated cost based on average US rate ($0.15/kWh).",
    ...
    faq: [
      ...
      {
        q: "How is monthly electricity cost obliczd?",
        a: "Cost = Power (kW) × Time (godzin) × Rate ($/kWh). This kalkulator uses the US average rate of $0.15/kWh. Your actual rate may vary by location and utility company.",
      },
      {
        q: "What's the difference between watts and watt-godzin?",
        a: "Watts measure instantaneous power (rate of energy use). Watt-godzin (Wh) measure total energy consumed over time. 1 kilowatt-hour (kWh) = 1000 W × 1 hour.",
      },
      {
        q: "Can I oblicz power from resistance and voltage?",
        a: "Yes. P = V² / R (voltage squared divided by resistance) gives power when you know voltage and resistance.",
      },
      {
        q: "How do I reduce my electricity bill?",
