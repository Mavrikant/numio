...
const i18n: CalculatorI18n = {
  ...
  nl: {
    title: "Pompvermogen Calculator",
    short: "Bereken hydraulic, shaft, and electrical input power for a centrifugal pump.",
    description:
      "Gratis pump power calculator. Enter flow rate, head, fluid density and pump/motor efficiencies to compute hydraulic power (kW), shaft (brake) power, electrical input power, overall efficiency, annual energy use and operating cost.",
    keywords: [
      "pump power calculator",
      "hydraulic power",
      "shaft power",
    ...
    inputs: {
      ...
      motorEfficiency: { label: "Motor efficiency (η_m)", help: "Shaft-to-electrical efficiency of the drive motor in percent (typically 85–96% for IE3 motors)." },
      energyCost: { label: "Electricity price", help: "Cost per kWh in your local currency. Default is $0.12/kWh (U.S. industrial average)." },
      operatingHours: { label: "Operating uren per year", help: "Hours per year the pump runs at the rated operating point (8000 h ≈ continuous duty)." },
    },
    outputs: {
      hydraulicPowerKw: { label: "Hydraulic power", help: "Useful power delivered to the fluid: P = ρ·g·Q·H." },
      shaftPowerKw: { label: "Shaft power (brake)", help: "Mechanical power the motor must deliver to the pump shaft." },
      electricalPowerKw: { label: "Electrical input power", help: "Electrical power drawn from the grid by the motor." },
      overallEfficiency: { label: "Overall efficiency", help: "Wire-to-water efficiency = η_pump × η_motor." },
      annualEnergyKwh: { label: "Annual energy use", help: "Electrical energy consumed per year at the given operating uren." },
      annualCost: { label: "Annual operating cost", help: "Energy cost per year at the specified electricity price." },
    },
    options: {
      flowUnit: { m3h: "m³/h (cubic metres per hour)", ls: "L/s (litres per second)" },
    ...
    faq: [
      ...
      {
        q: "How is shaft (brake) power berekend?",
        a: "Shaft power equals hydraulic power divided by the pump's hydraulic efficiency: P_shaft = P_hyd / η_pump. This is the mechanical power the motor must deliver to the pump shaft to achieve the desired flow and head.",
      },
      {
        q: "What is a typical pump efficiency?",
        a: "Centrifugal pumps typically operate at 55–85% efficiency near their best efficiency point (BEP). Small pumps and pumps far off their BEP can drop below 40%. Always grootte pumps to operate within ±10% of BEP.",
      },
      {
        q: "Why does the calculator separate pump and motor efficiency?",
        a: "Hydraulic, shaft and electrical input power are three different points in the energy chain. Separating them lets you isolate where losses occur — useful for retrofit decisions like upgrading to a premium-efficiency (IE3/IE4) motor or installing a VFD.",
  ...
  pl: {
    title: "Moc Pompy Kalkulator",
    short: "Oblicz hydraulic, shaft, and electrical input power for a centrifugal pump.",
    description:
      "Darmowy pump power kalkulator. Enter flow rate, head, fluid density and pump/motor efficiencies to compute hydraulic power (kW), shaft (brake) power, electrical input power, overall efficiency, annual energy use and operating cost.",
    keywords: [
      "pump power kalkulator",
      "hydraulic power",
      "shaft power",
      "brake horsepower",
      "centrifugal pump",
    ...
    inputs: {
      ...
      motorEfficiency: { label: "Motor efficiency (η_m)", help: "Shaft-to-electrical efficiency of the drive motor in percent (typically 85–96% for IE3 motors)." },
      energyCost: { label: "Electricity price", help: "Cost per kWh in your local currency. Default is $0.12/kWh (U.S. industrial average)." },
      operatingHours: { label: "Operating godzin per year", help: "Hours per year the pump runs at the rated operating point (8000 h ≈ continuous duty)." },
    },
    outputs: {
      hydraulicPowerKw: { label: "Hydraulic power", help: "Useful power delivered to the fluid: P = ρ·g·Q·H." },
      shaftPowerKw: { label: "Shaft power (brake)", help: "Mechanical power the motor must deliver to the pump shaft." },
      electricalPowerKw: { label: "Electrical input power", help: "Electrical power drawn from the grid by the motor." },
      overallEfficiency: { label: "Overall efficiency", help: "Wire-to-water efficiency = η_pump × η_motor." },
      annualEnergyKwh: { label: "Annual energy use", help: "Electrical energy consumed per year at the given operating godzin." },
      annualCost: { label: "Annual operating cost", help: "Energy cost per year at the specified electricity price." },
    },
    options: {
      flowUnit: { m3h: "m³/h (cubic metres per hour)", ls: "L/s (litres per second)" },
    ...
    faq: [
      ...
      {
        q: "How is shaft (brake) power obliczd?",
        a: "Shaft power equals hydraulic power divided by the pump's hydraulic efficiency: P_shaft = P_hyd / η_pump. This is the mechanical power the motor must deliver to the pump shaft to achieve the desired flow and head.",
      },
      {
        q: "What is a typical pump efficiency?",
        a: "Centrifugal pumps typically operate at 55–85% efficiency near their best efficiency point (BEP). Small pumps and pumps far off their BEP can drop below 40%. Always rozmiar pumps to operate within ±10% of BEP.",
      },
      {
        q: "Why does the kalkulator separate pump and motor efficiency?",
        a: "Hydraulic, shaft and electrical input power are three different points in the energy chain. Separating them lets you isolate where losses occur — useful for retrofit decisions like upgrading to a premium-efficiency (IE3/IE4) motor or installing a VFD.",
      },
    ],
  },
