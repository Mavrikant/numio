...
const i18n: CalculatorI18n = {
  ...
  nl: {
    title: "Weerstandskleur Code Calculator",
    short: "Decode 4-band and 5-band resistor kleur codes to find resistance value and tolerance.",
    description:
      "Gratis resistor kleur code decoder. Select the kleur bands on your resistor to direct identify the resistance value in ohms, the tolerance percentage, and the minimum and maximum resistance range.",
    keywords: [
      "resistor kleur code calculator",
      "resistor band decoder",
      "4 band resistor calculator",
      "5 band resistor calculator",
      "IEC 60062",
    ...
    inputs: {
      bandCount: { label: "Nummer of bands", help: "4-band resistors have 2 significant digits; 5-band have 3." },
      band1: { label: "Band 1 (1st digit)", help: "First significant digit kleur." },
      band2: { label: "Band 2 (2nd digit)", help: "Second significant digit kleur." },
      band3: { label: "Band 3 (3rd digit)", help: "Third significant digit (5-band only)." },
      multiplierBand: { label: "Multiplier band", help: "The multiplier kleur band." },
      toleranceBand: { label: "Tolerance band", help: "The tolerance kleur band." },
    },
    outputs: {
      resistance: { label: "Resistance (Ω)", help: "Nominal resistance value in ohms." },
      tolerancePct: { label: "Tolerance (%)", help: "Tolerance as a percentage of the nominal value." },
      minValue: { label: "Min value (Ω)", help: "Minimum resistance within tolerance." },
      maxValue: { label: "Max value (Ω)", help: "Maximum resistance within tolerance." },
      colorName1: { label: "Band 1 kleur" },
      colorName2: { label: "Band 2 kleur" },
      colorName3: { label: "Band 3 kleur" },
      multiplierColorName: { label: "Multiplier kleur" },
      toleranceColorName: { label: "Tolerance kleur" },
    },
    options: {
      bandCount: { fourBand: "4 Bands", fiveBand: "5 Bands" },
      band1: {
  ...
  pl: {
    title: "Oznaczenie Rezystora Kod Kalkulator",
    short: "Dekod 4-band and 5-band resistor kolor kods to find resistance value and tolerance.",
    description:
      "Darmowy resistor kolor kod dekoder. Select the kolor bands on your resistor to natychmiast identify the resistance value in ohms, the tolerance percentage, and the minimum and maximum resistance range.",
    keywords: [
      "resistor kolor kod kalkulator",
      "resistor band dekoder",
      "4 band resistor kalkulator",
      "5 band resistor kalkulator",
      "IEC 60062",
      "electronics resistor",
      "ohm kolor kod",
    ],
    inputs: {
      bandCount: { label: "Liczba of bands", help: "4-band resistors have 2 significant digits; 5-band have 3." },
      band1: { label: "Band 1 (1st digit)", help: "First significant digit kolor." },
      band2: { label: "Band 2 (2nd digit)", help: "Second significant digit kolor." },
      band3: { label: "Band 3 (3rd digit)", help: "Third significant digit (5-band only)." },
      multiplierBand: { label: "Multiplier band", help: "The multiplier kolor band." },
      toleranceBand: { label: "Tolerance band", help: "The tolerance kolor band." },
    },
    outputs: {
      resistance: { label: "Resistance (Ω)", help: "Nominal resistance value in ohms." },
      tolerancePct: { label: "Tolerance (%)", help: "Tolerance as a percentage of the nominal value." },
      minValue: { label: "Min value (Ω)", help: "Minimum resistance within tolerance." },
      maxValue: { label: "Max value (Ω)", help: "Maximum resistance within tolerance." },
      colorName1: { label: "Band 1 kolor" },
      colorName2: { label: "Band 2 kolor" },
      colorName3: { label: "Band 3 kolor" },
      multiplierColorName: { label: "Multiplier kolor" },
      toleranceColorName: { label: "Tolerance kolor" },
    },
    options: {
      bandCount: { fourBand: "4 Bands", fiveBand: "5 Bands" },
      band1: {
