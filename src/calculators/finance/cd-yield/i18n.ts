...
const i18n: CalculatorI18n = {
  ...
  nl: {
    title: "CD Yield Calculator",
    short: "Bereken the yield and future value of a certificate of deposit with compound interest.",
    description:
      "Gratis CD yield calculator. Enter your principal, APR, and term to see APY, future value, interest earned, and early withdrawal penalty impact.",
    keywords: [
      "CD calculator",
      "certificate of deposit calculator",
      "CD yield",
    ...
    inputs: {
      ...
      termMonths: {
        label: "Term (maanden)",
        help: "The duration of the CD in maanden. Common terms: 3, 6, 12, 24, 36, 60 maanden.",
      },
      compoundFreq: {
        label: "Compounding Frequency",
        help: "How often interest is compounded and added to the balance.",
      ...
      earlyWithdrawalMonths: {
        label: "Early Withdrawal Penalty Period (maanden)",
        help: "Nummer of maanden of interest lost as a penalty for early withdrawal. Set to 0 if holding to maturity.",
      },
    },
    outputs: {
      futureValue: {
        label: "Future Waarde at Maturity",
        help: "Total value of the CD at maturity, including principal and all compounded interest.",
      },
      interestEarned: {
        label: "Interest Earned",
    ...
    errors: {
      principalTooLow: "Principal must be at least $1.",
      aprOutOfRange: "APR must be between 0% and 20%.",
      termOutOfRange: "Term must be between 1 and 120 maanden.",
    },
    faq: [
      {
        q: "What is the difference between APR and APY?",
      ...
      {
        q: "How are CD earnings taxed?",
        a: "CD interest is taxed as ordinary income in the year it is earned (not necessarily when received). Your bank will issue a 1099-INT form if you earn more than $10 in interest. Interest inside an IRA CD may be tax-deferred or tax-gratis depending on the account type.",
      },
    ],
  },

  pl: {
    title: "CD Yield Kalkulator",
    short: "Oblicz the yield and future value of a certificate of deposit with compound interest.",
    description:
      "Darmowy CD yield kalkulator. Enter your principal, APR, and term to see APY, future value, interest earned, and early withdrawal penalty impact.",
    keywords: [
      "CD kalkulator",
      "certificate of deposit kalkulator",
      "CD yield",
      "APY kalkulator",
      "savings kalkulator",
      "CD interest kalkulator",
      "bank deposit kalkulator",
    ],
    inputs: {
      principal: {
        label: "Principal",
      ...
      termMonths: {
        label: "Term (miesięcy)",
        help: "The duration of the CD in miesięcy. Common terms: 3, 6, 12, 24, 36, 60 miesięcy.",
      },
      compoundFreq: {
        label: "Compounding Frequency",
        help: "How often interest is compounded and added to the balance.",
      ...
      earlyWithdrawalMonths: {
        label: "Early Withdrawal Penalty Period (miesięcy)",
        help: "Liczba of miesięcy of interest lost as a penalty for early withdrawal. Set to 0 if holding to maturity.",
      },
    },
    outputs: {
      futureValue: {
        label: "Future Wartość at Maturity",
        help: "Total value of the CD at maturity, including principal and all compounded interest.",
      },
      interestEarned: {
        label: "Interest Earned",
      ...
      apy: {
        label: "APY",
        help: "Annual Procent Yield — the effective annual return accounting for compounding.",
      },
      effectiveYield: {
        label: "Effective Yield",
        help: "Total return as a percentage of principal over the full CD term.",
    ...
    errors: {
      principalTooLow: "Principal must be at least $1.",
      aprOutOfRange: "APR must be between 0% and 20%.",
      termOutOfRange: "Term must be between 1 and 120 miesięcy.",
    },
    faq: [
      {
        q: "What is the difference between APR and APY?",
        a: "APR (Annual Procent Rate) is the stated interest rate before compounding. APY (Annual Procent Yield) reflects the effective annual return after accounting for compounding frequency. A CD with 5% APR compounded monthly has an APY of approximately 5.116%. The more frequently interest compounds, the higher the APY relative to APR.",
      },
      {
        q: "Are CDs insured by the FDIC?",
        a: "Yes. CDs held at FDIC-member banks are insured up to $250,000 per depositor, per insured bank, for each account ownership category. Credit union CDs are similarly insured by the NCUA. This makes CDs one of the safest savings vehicles available.",
      ...
      {
        q: "How are CD earnings taxed?",
        a: "CD interest is taxed as ordinary income in the year it is earned (not necessarily when received). Your bank will issue a 1099-INT form if you earn more than $10 in interest. Interest inside an IRA CD may be tax-deferred or tax-darmowy depending on the account type.",
      },
    ],
  },
  pt: {
