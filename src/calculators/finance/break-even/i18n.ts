...
const i18n: CalculatorI18n = {
  ...
  nl: {
    ...
    short: "Find the sales volume where total revenue equals total cost — your break-even point.",
    description:
      "Gratis break-even calculator using the standard cost-volume-profit (CVP) formula. Enter your fixed costs, variable cost per unit, and selling price to see how many units you must sell to cover all costs, along with contribution margin per unit and as a percentage of price.",
    keywords: [
      "break-even calculator",
      "break-even analysis",
      "contribution margin",
    ...
    outputs: {
      breakEvenUnits: { label: "Break-Even Units", help: "Nummer of units you must sell so that total revenue exactly equals total cost." },
      breakEvenRevenue: { label: "Break-Even Revenue", help: "Sales dollars required to cover all fixed and variable costs (break-even units × price)." },
      contributionMarginPerUnit: { label: "Contribution Marge per Unit", help: "Price minus variable cost — the amount each unit contributes toward fixed costs and profit." },
      contributionMarginPercent: { label: "Contribution Marge %", help: "Contribution margin as a percentage of selling price." },
    },
    errors: {
      priceMustExceedVariableCost: "Selling price must be greater than the variable cost per unit.",
      fixedCostsRange: "Fixed costs must be between $0 and $1,000,000,000.",
  ...
  pl: {
    title: "Próg Rentowności Kalkulator",
    short: "Find the sales volume where total revenue equals total cost — your break-even point.",
    description:
      "Darmowy break-even kalkulator using the standard cost-volume-profit (CVP) formula. Enter your fixed costs, variable cost per unit, and selling price to see how many units you must sell to cover all costs, along with contribution margin per unit and as a percentage of price.",
    keywords: [
      "break-even kalkulator",
      "break-even analysis",
      "contribution margin",
      "CVP analysis",
      "fixed cost kalkulator",
      "business profitability",
      "break-even point",
    ],
    inputs: {
    ...
    outputs: {
      breakEvenUnits: { label: "Próg Rentowności Units", help: "Liczba of units you must sell so that total revenue exactly equals total cost." },
      breakEvenRevenue: { label: "Próg Rentowności Revenue", help: "Sales dollars required to cover all fixed and variable costs (break-even units × price)." },
      contributionMarginPerUnit: { label: "Contribution Marża per Unit", help: "Price minus variable cost — the amount each unit contributes toward fixed costs and profit." },
      contributionMarginPercent: { label: "Contribution Marża %", help: "Contribution margin as a percentage of selling price." },
    },
    errors: {
      priceMustExceedVariableCost: "Selling price must be greater than the variable cost per unit.",
      fixedCostsRange: "Fixed costs must be between $0 and $1,000,000,000.",
    ...
    faq: [
      ...
      {
        q: "Does this include taxes?",
        a: "This kalkulator computes the operating (pre-tax) break-even point. To find the units required for a target after-tax profit, divide the target pre-tax profit (target after-tax profit / (1 − tax rate)) by the contribution margin per unit and add it to break-even units.",
      },
    ],
  },
  pt: {
