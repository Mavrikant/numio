...
const i18n: CalculatorI18n = {
  ...
  nl: {
    title: "Spaargeld Goal Calculator",
    short: "Find out how many maanden it takes to reach your savings target.",
    description:
      "Gratis savings goal calculator. Enter your target amount, current savings, monthly contribution, and expected annual return to see exactly when you will reach your goal.",
    keywords: [
      "savings goal calculator",
      "how long to save",
      "monthly savings",
    ...
    outputs: {
      monthsToGoal: {
        label: "Months to Goal",
        help: "How many maanden until you reach your savings target.",
      },
      yearsToGoal: {
        label: "Years to Goal",
        help: "The same period expressed in jaren.",
      },
      totalContributions: {
        label: "Total Contributions",
        help: "Sum of your initial savings plus all monthly deposits.",
    ...
    errors: {
      ...
      contributionTooLow: "Monthly contribution must be greater than zero.",
      goalNotReachable:
        "With these inputs, the goal cannot be reached within 100 jaren.",
    },
    faq: [
      {
        q: "What annual return should I use?",
  ...
  pl: {
    title: "Oszczędności Goal Kalkulator",
    short: "Find out how many miesięcy it takes to reach your savings target.",
    description:
      "Darmowy savings goal kalkulator. Enter your target amount, current savings, monthly contribution, and expected annual return to see exactly when you will reach your goal.",
    keywords: [
    ...
    outputs: {
      monthsToGoal: {
        label: "Months to Goal",
        help: "How many miesięcy until you reach your savings target.",
      },
      yearsToGoal: {
        label: "Years to Goal",
        help: "The same period expressed in lat.",
      },
      totalContributions: {
        label: "Total Contributions",
        help: "Sum of your initial savings plus all monthly deposits.",
    ...
    errors: {
      ...
      contributionTooLow: "Monthly contribution must be greater than zero.",
      goalNotReachable:
        "With these inputs, the goal cannot be reached within 100 lat.",
    },
    faq: [
      {
        q: "What annual return should I use?",
      ...
      {
        q: "Does the kalkulator account for inflation?",
        a: "No. Enter a 'real' return rate (nominal rate minus expected inflation, roughly 2–3%) to get inflation-adjusted results.",
      },
      {
        q: "What if I cannot contribute the same amount every month?",
        a: "Use your average monthly contribution as the input. You can re-run the kalkulator whenever your contribution amount changes.",
      },
    ],
  },
  pt: {
