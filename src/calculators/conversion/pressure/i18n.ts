...
const i18n: CalculatorI18n = {
  ...
  tr: {
    ...
    keywords: ["basınç dönüştürücü", "psi bar", "bar kpa", "atm mmhg", "pascal", "torr"],
    inputs: {
    ...
    outputs: { result: { label: "Sonuç", help: "Dönüştürülen basınç değeri." } },
    options: {
      Pa: "Paskal (Pa)",
      kPa: "Kilopaskal (kPa)",
      MPa: "Megapaskal (MPa)",
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100.000 Pa ≈ 14,5038 psi. Bar metrik birimdir (Avrupa), psi ABD birimidir (lastik, hidrolik).",
      },
      {
        question: "Bir atmosferde kaç pascal vardır?",
        answer: "1 standart atmosfer (atm), tanım gereği tam olarak 101.325 Pa'dır (yaklaşık 1,01325 bar veya 14,696 psi).",
      },
      {
        question: "mmHg ve torr arasındaki fark nedir?",
        answer: "Neredeyse aynıdırlar: 1 torr = 1/760 atm ≈ 133,3224 Pa, 1 mmHg = 133,3224 Pa. Aradaki fark 10⁷'de 1'den azdır.",
      },
      {
        question: "psi'yi kPa'ya nasıl dönüştürürüm?",
        answer: "psi değerini 6,894757 ile çarpın. Örneğin, 30 psi ≈ 206,84 kPa (tipik araba lastiği basıncı).",
      },
    ],
  },
  de: {
    title: "Druckumrechner",
    short: "Rechnen Sie zwischen Pa, kPa, bar, psi, atm, mmHg und weiteren Druckeinheiten um.",
    description:
      "Kostenloser Druckeinheiten-Umrechner. Umrechnung zwischen Pa, kPa, MPa, bar, psi, atm, mmHg, torr und inHg mit NIST-Genauigkeit.",
    keywords: ["druckumrechner", "psi bar", "bar kpa", "atm mmhg", "pascal", "torr"],
    inputs: {
    ...
    outputs: { result: { label: "Ergebnis", help: "Der umgerechnete Druckwert." } },
    options: {
      Pa: "Pascal (Pa)",
      kPa: "Kilopascal (kPa)",
      MPa: "Megapascal (MPa)",
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100.000 Pa ≈ 14,5038 psi. Bar ist metrisch (Europa), psi US-üblich (Reifen, Hydraulik).",
      },
      {
        question: "Wie viele Pascal sind in einer Atmosphäre?",
        answer: "1 standard atmosphere (atm) entspricht per Definition genau 101.325 Pa (etwa 1,01325 bar oder 14,696 psi).",
      },
      {
        question: "Was ist der Unterschied zwischen mmHg und torr?",
        answer: "Sie sind nahezu identisch: 1 torr = 1/760 atm ≈ 133,3224 Pa, während 1 mmHg = 133,3224 Pa. Die Werte unterscheiden sich um weniger als 1 zu 10⁷.",
      },
      {
        question: "Wie konvertiere ich psi in kPa?",
        answer: "Multiplizieren Sie psi mit 6,894757 für kPa. Beispiel: 30 psi ≈ 206,84 kPa (typischer Autoreifendruck).",
      },
    ],
  },
  fr: {
    ...
    keywords: ["convertisseur pression", "psi bar", "bar kpa", "atm mmhg", "pascal", "torr"],
    inputs: {
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100 000 Pa ≈ 14,5038 psi. Le bar est métrique (Europe), le psi est US (pneus, hydraulique).",
      },
      {
        question: "Combien de pascals y a-t-il dans une atmosphère ?",
        answer: "1 atmosphère standard (atm) équivaut exactement à 101 325 Pa par définition (environ 1,01325 bar ou 14,696 psi).",
      },
      {
        question: "Quelle est la différence entre mmHg et torr ?",
        answer: "Ils sont quasiment identiques : 1 torr = 1/760 atm ≈ 133,3224 Pa, tandis que 1 mmHg = 133,3224 Pa. L'écart est inférieur à 1 sur 10⁷.",
      },
      {
        question: "Comment convertir psi en kPa ?",
        answer: "Multipliez les psi par 6,894757 pour obtenir des kPa. Par exemple, 30 psi ≈ 206,84 kPa (pression typique des pneus).",
      },
    ],
  },
  es: {
    ...
    keywords: ["conversor presión", "psi bar", "bar kpa", "atm mmhg", "pascal", "torr"],
    inputs: {
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100.000 Pa ≈ 14,5038 psi. Bar es métrico (Europa), psi es estadounidense (neumáticos, hidráulica).",
      },
      {
        question: "¿Cuántos pascales hay en una atmósfera?",
        answer: "1 atmósfera estándar (atm) equivale por definición exactamente a 101.325 Pa (≈ 1,01325 bar o 14,696 psi).",
      },
      {
        question: "¿Cuál es la diferencia entre mmHg y torr?",
        answer: "Son casi idénticos: 1 torr = 1/760 atm ≈ 133,3224 Pa, mientras que 1 mmHg = 133,3224 Pa. La diferencia es menor de 1 en 10⁷.",
      },
      {
        question: "¿Cómo convierto psi a kPa?",
        answer: "Multiplique psi por 6,894757 para obtener kPa. Por ejemplo, 30 psi ≈ 206,84 kPa (presión típica de neumático).",
      },
    ],
  },
  it: {
    ...
    keywords: ["convertitore pressione", "psi bar", "bar kpa", "atm mmhg", "pascal", "torr"],
    inputs: {
    ...
    outputs: { result: { label: "Risultato", help: "La pressione convertita." } },
    options: {
      Pa: "Pascal (Pa)",
      kPa: "Kilopascal (kPa)",
      MPa: "Megapascal (MPa)",
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100.000 Pa ≈ 14,5038 psi. Il bar è metrico (Europa), lo psi è statunitense (pneumatici, idraulica).",
      },
      {
        question: "Quanti pascal ci sono in un'atmosfera?",
        answer: "1 atmosfera standard (atm) equivale per definizione esattamente a 101.325 Pa (circa 1,01325 bar o 14,696 psi).",
      },
      {
        question: "Qual è la differenza tra mmHg e torr?",
        answer: "Sono quasi identici: 1 torr = 1/760 atm ≈ 133,3224 Pa, mentre 1 mmHg = 133,3224 Pa. Lo scarto è inferiore a 1 su 10⁷.",
      },
      {
        question: "Come converto psi in kPa?",
        answer: "Moltiplicare psi per 6,894757 per ottenere kPa. Esempio: 30 psi ≈ 206,84 kPa (pressione tipica degli pneumatici).",
      },
    ],
  },
  ar: {
    ...
    faq: [
      {
        ...
        answer: "1 بار = 100,000 Pa ≈ 14.5038 psi. البار وحدة مترية (أوروبا)، و psi وحدة أمريكية (إطارات السيارات والهيدروليك).",
      },
      {
        question: "كم باسكال في الجو الواحد (atm)؟",
        answer: "1 جو قياسي (atm) يساوي بالتعريف بالضبط 101,325 Pa (حوالي 1.01325 بار أو 14.696 psi).",
      },
      {
        question: "ما الفرق بين mmHg و torr؟",
        answer: "هما متطابقتان تقريباً: 1 torr = 1/760 atm ≈ 133.3224 Pa، و 1 mmHg = 133.3224 Pa. الفرق أقل من 1 في 10⁷.",
      },
      {
        question: "كيف أحول psi إلى kPa؟",
        answer: "اضرب قيمة psi في 6.894757 للحصول على kPa. مثال: 30 psi ≈ 206.84 kPa (ضغط إطار السيارة النموذجي).",
      },
    ],
  },
  ru: {
    title: "Конвертер давления",
    short: "Преобразование между Па, кПа, бар, psi, атм, мм рт. ст. и другими единицами давления.",
    description:
      "Бесплатный конвертер единиц давления. Преобразование между Pa, kPa, MPa, bar, psi, atm, mmHg, torr и inHg с точностью NIST.",
    keywords: ["конвертер давления", "psi bar", "bar kpa", "atm mmhg", "паскаль", "торр"],
    inputs: {
      value: { label: "Значение", help: "Значение давления для преобразования." },
      fromUnit: { label: "От", help: "Выберите исходную единицу." },
      toUnit: { label: "К", help: "Выберите целевую единицу." },
    },
    outputs: { result: { label: "Результат", help: "Преобразованное значение давления." } },
    options: {
      Pa: "Паскаль (Pa)",
      kPa: "Килопаскаль (kPa)",
      MPa: "Мегапаскаль (MPa)",
    ...
    faq: [
      {
        ...
        answer: "1 бар = 100 000 Pa ≈ 14,5038 psi. Бар — метрическая единица (Европа), psi — американская (шины, гидравлика).",
      },
      {
        question: "Сколько паскалей в одной атмосфере?",
        answer: "1 стандартная атмосфера (atm) равна по определению точно 101 325 Pa (примерно 1,01325 бар или 14,696 psi).",
      },
      {
        question: "В чём разница между mmHg и torr?",
        answer: "Они почти идентичны: 1 torr = 1/760 atm ≈ 133,3224 Pa, тогда как 1 mmHg = 133,3224 Pa. Разница менее 1 на 10⁷.",
      },
      {
        question: "Как преобразовать psi в kPa?",
        answer: "Умножьте psi на 6,894757, чтобы получить kPa. Пример: 30 psi ≈ 206,84 kPa (типичное давление в автошине).",
      },
    ],
  },
  zh: {
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100,000 Pa ≈ 14.5038 psi。bar 是公制单位（欧洲），psi 是美制单位（轮胎、液压）。",
      },
      {
        question: "1 个大气压等于多少帕？",
        answer: "1 标准大气压 (atm) 按定义恰好等于 101,325 Pa（约 1.01325 bar 或 14.696 psi）。",
      },
      {
        question: "mmHg 和 torr 有什么区别？",
        answer: "二者几乎相同：1 torr = 1/760 atm ≈ 133.3224 Pa，1 mmHg = 133.3224 Pa，差值不到 10⁷ 分之 1。",
      },
      {
        question: "如何将 psi 转换为 kPa？",
        answer: "psi 乘以 6.894757 得到 kPa。例如 30 psi ≈ 206.84 kPa（典型汽车胎压）。",
      },
    ],
  },
  ja: {
    ...
    keywords: ["圧力コンバーター", "psi bar", "bar kpa", "atm mmhg", "パスカル", "トル"],
    inputs: {
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100,000 Pa ≈ 14.5038 psi。bar はメートル系（ヨーロッパ）、psi は米国系（タイヤ、油圧）。",
      },
      {
        question: "1 気圧は何パスカルですか？",
        answer: "1 標準気圧 (atm) は定義により正確に 101,325 Pa（約 1.01325 bar または 14.696 psi）です。",
      },
      {
        question: "mmHg と torr の違いは？",
        answer: "ほぼ同じです：1 torr = 1/760 atm ≈ 133.3224 Pa、1 mmHg = 133.3224 Pa で、差は 10⁷ 分の 1 以下です。",
      },
      {
        question: "psi を kPa に変換するには？",
        answer: "psi に 6.894757 を掛けると kPa になります。例: 30 psi ≈ 206.84 kPa（一般的な車のタイヤ空気圧）。",
      },
    ],
  },
  ko: {
    title: "압력 변환기",
    short: "Pa, kPa, bar, psi, atm, mmHg 및 기타 압력 단위 사이에서 변환하세요.",
    description:
      "무료 압력 단위 변환기. Pa, kPa, MPa, bar, psi, atm, mmHg, torr, inHg 사이를 NIST 수준의 정밀도로 변환합니다.",
    keywords: ["압력 변환기", "psi bar", "bar kpa", "atm mmhg", "파스칼", "토르"],
    inputs: {
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100,000 Pa ≈ 14.5038 psi. bar 는 미터법(유럽)이고, psi 는 미국식(타이어·유압)입니다.",
      },
      {
        question: "1 기압은 몇 파스칼인가요?",
        answer: "1 표준 대기압(atm)은 정의상 정확히 101,325 Pa 입니다 (약 1.01325 bar 또는 14.696 psi).",
      },
      {
        question: "mmHg 와 torr 의 차이는?",
        answer: "거의 동일합니다: 1 torr = 1/760 atm ≈ 133.3224 Pa, 1 mmHg = 133.3224 Pa. 차이는 10⁷ 분의 1 미만입니다.",
      },
      {
        question: "psi 를 kPa 로 변환하려면?",
        answer: "psi 에 6.894757 을 곱하면 kPa 입니다. 예: 30 psi ≈ 206.84 kPa (일반 자동차 타이어 압력).",
      },
    ],
  },
  hi: {
    title: "दबाव परिवर्तक",
    short: "Pa, kPa, bar, psi, atm, mmHg और अन्य दबाव इकाइयों के बीच रूपांतरण करें।",
    description:
      "मुफ्त दबाव इकाई परिवर्तक। Pa, kPa, MPa, bar, psi, atm, mmHg, torr और inHg के बीच NIST स्तर की सटीकता से रूपांतरण।",
    keywords: ["दबाव परिवर्तक", "psi bar", "bar kpa", "atm mmhg", "पास्कल", "टोर"],
    inputs: {
    ...
    faq: [
      {
        ...
        answer: "1 bar = 100,000 Pa ≈ 14.5038 psi। bar मीट्रिक है (यूरोप), psi अमेरिकी है (टायर, हाइड्रोलिक)।",
      },
      {
        question: "एक वायुमंडल में कितने पास्कल होते हैं?",
        answer: "1 मानक वायुमंडल (atm) परिभाषा के अनुसार ठीक 101,325 Pa के बराबर है (लगभग 1.01325 bar या 14.696 psi)।",
      },
      {
        question: "mmHg और torr में क्या अंतर है?",
        answer: "वे लगभग समान हैं: 1 torr = 1/760 atm ≈ 133.3224 Pa, और 1 mmHg = 133.3224 Pa। अंतर 10⁷ में 1 से कम है।",
      },
      {
        question: "psi को kPa में कैसे बदलें?",
        answer: "psi को 6.894757 से गुणा करें ताकि kPa प्राप्त हो। उदाहरण: 30 psi ≈ 206.84 kPa (सामान्य कार टायर दबाव)।",
      },
    ],
  },
};
