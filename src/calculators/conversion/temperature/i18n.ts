...
const i18n: CalculatorI18n = {
  en: {
    ...
    inputs: {
      ...
      reaumur: { label: "Réaumur", help: "Temperature in Réaumur" },
      rankine: { label: "Rankine", help: "Temperature in Rankine" },
    },
    outputs: {
  ...
  pt: {
    ...
    inputs: {
      celsius: { label: "Celsius", help: "Temperatura em Celsius" },
      fahrenheit: { label: "Fahrenheit", help: "Temperatura em Fahrenheit" },
      kelvin: { label: "Kelvin", help: "Temperatura em Kelvin" },
      reaumur: { label: "Réaumur", help: "Temperatura em Réaumur" },
      rankine: { label: "Rankine", help: "Temperatura em Rankine" },
    },
    outputs: {
  ...
  id: {
    ...
    inputs: {
      celsius: { label: "Celsius", help: "Suhu dalam Celsius" },
      fahrenheit: { label: "Fahrenheit", help: "Suhu dalam Fahrenheit" },
      kelvin: { label: "Kelvin", help: "Suhu dalam Kelvin" },
      reaumur: { label: "Réaumur", help: "Suhu dalam Réaumur" },
      rankine: { label: "Rankine", help: "Suhu dalam Rankine" },
    },
    outputs: {
  ...
  tr: {
    ...
    inputs: {
      ...
      reaumur: { label: "Réaumur", help: "Réaumur cinsinden sıcaklık" },
      rankine: { label: "Rankine", help: "Rankine cinsinden sıcaklık" },
    },
    outputs: {
  ...
  de: {
    ...
    inputs: {
      ...
      reaumur: { label: "Réaumur", help: "Temperatur in Réaumur" },
      rankine: { label: "Rankine", help: "Temperatur in Rankine" },
    },
    outputs: {
  ...
  fr: {
    ...
    inputs: {
      ...
      reaumur: { label: "Réaumur", help: "Température en Réaumur" },
      rankine: { label: "Rankine", help: "Température en Rankine" },
    },
    outputs: {
  ...
  es: {
    ...
    inputs: {
      ...
      reaumur: { label: "Réaumur", help: "Temperatura en Réaumur" },
      rankine: { label: "Rankine", help: "Temperatura en Rankine" },
    },
    outputs: {
  ...
  it: {
    ...
    inputs: {
      ...
      reaumur: { label: "Réaumur", help: "Temperatura in Réaumur" },
      rankine: { label: "Rankine", help: "Temperatura in Rankine" },
    },
    outputs: {
  ...
  ar: {
    ...
    inputs: {
      ...
      reaumur: { label: "رءومور", help: "درجة الحرارة بالرءومور" },
      rankine: { label: "رانكين", help: "درجة الحرارة بالرانكين" },
    },
    outputs: {
  ...
  ru: {
    ...
    inputs: {
      ...
      reaumur: { label: "Реомюр", help: "Температура в Реомюр" },
      rankine: { label: "Ранкин", help: "Температура в Ранкин" },
    },
    outputs: {
  ...
  zh: {
    ...
    inputs: {
      ...
      reaumur: { label: "列氏度", help: "列氏度温度" },
      rankine: { label: "兰氏度", help: "兰氏度温度" },
    },
    outputs: {
  ...
  ja: {
    ...
    inputs: {
      ...
      reaumur: { label: "レオミュール", help: "レオミュール温度" },
      rankine: { label: "ランキン", help: "ランキン温度" },
    },
    outputs: {
  ...
  ko: {
    ...
    inputs: {
      ...
      reaumur: { label: "레오뮈르", help: "레오뮈르 온도" },
      rankine: { label: "랭킨", help: "랭킨 온도" },
    },
    outputs: {
  ...
  hi: {
    ...
    inputs: {
      ...
      reaumur: { label: "रेओमुर", help: "रेओमुर तापमान" },
      rankine: { label: "रैंकिन", help: "रैंकिन तापमान" },
    },
    outputs: {
