...
const i18n: CalculatorI18n = {
  en: {
    ...
    short: "Convert between byte and bit data units with binary (1024) or decimal (1000) mode.",
    description:
      "Free data storage converter supporting binary (KiB, MiB, GiB) and decimal (KB, MB, GB) conversions between bytes, kilobytes, megabytes, gigabytes, terabytes, petabytes, and bit units (bit, Kbit, Mbit, Gbit) — including byte-to-bit conversions like Megabyte to Megabit.",
    keywords: [
    ...
    faq: [
      ...
      {
        q: "How do I convert bytes to bits (e.g. Megabyte to Megabit)?",
        a: "One byte equals 8 bits, so the same applies to every prefix: 1 Megabyte = 8 Megabit, 1 Gigabyte = 8 Gigabit. Pick a byte unit on one side (MB) and a bit unit on the other (Mbit) to convert across. Byte units use an uppercase B (MB) and bit units a lowercase b (Mb).",
      },
    ],
  },
  pt: {
