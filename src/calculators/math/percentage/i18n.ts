...
const i18n: CalculatorI18n = {
  ...
  nl: {
    title: "Percentage Calculator",
    short: "Bereken percentages direct: X% of Y, X is what % of Y, or percentage change.",
    description:
      "Gratis 3-in-1 percentage calculator. Find what X% of Y is, bereken what percentage X is of Y, or compute percentage change between two values.",
    keywords: [
      "percentage calculator",
      "percent calculator",
      "percentage change calculator",
    ...
    inputs: {
      mode: {
        label: "Problem type",
        help: "Choose what you want to bereken",
      },
      x: {
        label: "First value",
        help: "The percentage or part (varies by problem type)",
  ...
  pl: {
    title: "Procent Kalkulator",
    short: "Oblicz percentages natychmiast: X% of Y, X is what % of Y, or percentage change.",
    description:
      "Darmowy 3-in-1 percentage kalkulator. Find what X% of Y is, oblicz what percentage X is of Y, or compute percentage change between two values.",
    keywords: [
    ...
    inputs: {
      mode: {
        label: "Problem type",
        help: "Choose what you want to oblicz",
      },
      x: {
        label: "First value",
        help: "The percentage or part (varies by problem type)",
    ...
    options: {
      mode: {
        "what_is_x_pct_of_y": "X% of Y",
        "x_is_what_pct_of_y": "X is what % of Y",
        "pct_change": "Procent change from X to Y",
      },
    },
    errors: {
      divideByZero: "Cannot divide by zero",
    ...
    faq: [
      {
        q: "What does 'percentage' mean?",
        a: "Procent (%) means 'per hundred'. For example, 25% means 25 out of 100, or 0.25 as a decimal.",
      },
      {
        q: "How do I oblicz X% of Y?",
        a: "Multiply Y by X and divide by 100. Formula: (X / 100) × Y. Example: 25% of 200 = (25 / 100) × 200 = 50.",
      },
      {
        q: "How do I find what percentage X is of Y?",
      ...
      {
        q: "What is percentage change?",
        a: "Procent change measures how much a value has changed relative to its original value. Formula: ((New - Old) / Old) × 100. A positive result means increase, negative means decrease.",
      },
      {
        q: "Can percentages exceed 100%?",
        a: "Yes. A percentage greater than 100% means the new value exceeds the original (e.g., growing from 50 to 150 is a 200% increase). Procents can also be negative for decreases.",
      },
    ],
  },
  pt: {
