...
- Khan Academy: [Mean, Median, Mode Review](https://www.khanacademy.org/math/statistics-probability/summarizing-quantitative-data/mean-median-basics/a/mean-median-and-mode-review)
- Wolfram MathWorld: [Arithmetic Mean](https://mathworld.wolfram.com/ArithmeticMean.html)
- NIST/SEMATECH: [Measures of Central Tendency](https://www.itl.nist.gov/div898/handbook/eda/section3/eda351.htm)
